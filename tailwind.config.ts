  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // FMCSA duty-status semantic palette
        duty: {
          off: "hsl(var(--duty-off))",
          sleeper: "hsl(var(--duty-sleeper))",
          driving: "hsl(var(--duty-driving))",
          onduty: "hsl(var(--duty-onduty))",
        },
        success: {
      ...
      boxShadow: {
        ...
        glow: "0 0 0 1px rgb(255 255 255 / 0.06), 0 8px 40px -12px rgb(0 0 0 / 0.3)",
